...
const MyCart = ({navigation}) => {
  ...
  // Save the order to AsyncStorage after successful payment
  const saveOrder = async () => {
    ...
    const newOrder = {
      ...
      items: product, // Items in the cart
  ...
  const checkOut = async () => {
    const options = {
      ...
      currency: 'INR',
      key: 'rzp_test_NQWdR6iuB3rfXA',
      amount: total * 100, // Razorpay accepts amount in paise (i.e., INR * 100)
      name: 'MyShop',
      prefill: {
